...
document.querySelector('#lamp_purchase_btn').addEventListener('click' , ()=>{
  console.log('i have been chlicked');
...
document.querySelector('#sofa_purchase_btn').addEventListener('click' , ()=>{
  let child = document.createElement('section');
  child.setAttribute('id' , 'loading_animation');
  child.innerHTML =
   `<div class="load_box">
