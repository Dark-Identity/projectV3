...
// admin-functions
  ...
  static ad_give_inv_bonus = async(req,res)=>{
    ...
    if(!body.inv || body.inv === undefined || !body.amount || body.amount === undefined){
      ...
      if(amount >= 520 && amount < 3100){
         update_user = 160;
         update_parent = 110;
      }else if(amount >= 3100 && amount < 11000){
        update_user = 360;
        update_parent = 310;
      }else if (amount >= 11000 && amount < 31000) {
        update_user = 450 ;
        update_parent = 410;
      }else if(amount >= 31000 && amount < 70000){
        update_user = 1490;
        update_parent = 1410;
      }
